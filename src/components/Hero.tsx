...
const Hero = ({ isVisible, setIsVisible, scrollToAboutUs }) => {
  ...
  return (
    <main
      className={`overflow-hidden h-screen max-w-screen bg-black relative ${
        isActive ? "animate-slideOutFromBottom" : "bg-black"
      }`}
      onClick={handleClick}
    >
      ...
      <section className="overflow-hidden z-10">
        <img
          src={hero}
          alt="hero"
          className="absolute bottom-0 right-[12vw] lg:h-[95vh] lg:right-0 animate-slideInFromBottom md:w-[70vw] sm:w-[80vw] h-[50vh] scale-[225%] sm:scale-100"
        />
      </section>
      ...
      <section className="my-2 absolute bottom-4 ml-4 lg:ml-10 lg:relative lg:bottom-0">
        <button className="font-medium text-white bg-[#FFB300] text-lg md:text-4xl md:px-10 md:pb-2 rounded-[0.6rem] px-2 py-1 my-4 animate-slideInFromLeft ">
          Subscribe
        </button>
      </section>
    </main>
