...
//             <div
//                 ref={popupRef}
//                 className="bg-white w-[90vw] lg:h-[70vh] lg:w-[70vw] rounded-xl lg:rounded-3xl flex font-montserrat relative z-30"
//             >
...
const JoinUsPopupComponent: React.FC<PopupProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div
                ref={popupRef}
                className="bg-white w-[90vw] lg:h-[70vh] lg:w-[70vw] rounded-xl lg:rounded-lg flex t overflow-hidden "
            >
                <section className="w-[20%] h-[100%] hidden lg:block">
                    <img src={joinUsPopup} alt="joinUs" className="object-cover h-full w-full rounded-t-lg" />
                </section>
